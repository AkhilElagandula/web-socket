...
@Component({
  selector: 'app-portfolio-details-segment-test',
  templateUrl: './portfolio-details-segment.component.html',
  styleUrls: ['./portfolio-details-segment.component.css']
})
export class PortfolioDetailsSegmentComponentTest implements OnInit {

  constructor(public _portfolioService: PortfolioService, public odinWebSocketService: OdinwebsocketserviceService) {
