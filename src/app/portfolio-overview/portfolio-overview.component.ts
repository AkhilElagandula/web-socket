...
export class PortfolioOverviewComponent implements OnInit {
  constructor(private _portfolioService: PortfolioService, public odinWebSocketService: OdinwebsocketService, public currency: CurrencyPipe) {
      ...
      if (keylist.includes(key)) {
        ...
        for (let i = 0; i < this.overViewData.length; i++) {
          ...
          if (this.scriplist[key].QTY >= 0) {
            ...
            this.totalGL = this.marketValue + this.overViewData[i]['AI'];
            // this.totalGL = this.changePrice(this.totalGL);
            this.totalGLP = (this.marketValue + this.overViewData[i]['AI']) * 100 / this.overViewData[i]['AI'];
          }
  ...
  GainLooseValue() {
    ...
    // this.overallReturn= this.changePrice(this.overallReturn);
    // console.log('overall', this.overallReturn);
    return null;
  }
